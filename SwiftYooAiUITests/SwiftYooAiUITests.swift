//
//  SwiftYooAiUITests.swift
//  SwiftYooAiUITests
//
//  Created by Zachary Oxendine on 5/5/21.
//

import XCTest

class SwiftYooAiUITests: XCTestCase {
    ...
    func testEditingItemUpdatesCorrectly() {
        // Go to Open Projects, add one project and one item before the test.
