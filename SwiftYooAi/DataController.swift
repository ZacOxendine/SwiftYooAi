...
//  SwiftYooAi
//
//  Created by Zachary Oxendine on 10/27/20.
//
...
class DataController: ObservableObject {
    ...
    /// Initializes a data controller, either in memory (for temporary use such as testing),
    ...
    /// This silently ignores errors caused by saving,
